...
#define StrRemove			Helper_StrRemoveW
...
#define StrRemove			Helper_StrRemoveA
...
extern "C"{
  ...
  DLLXEXPORT LPSTR  WINAPI Helper_StrDupA(LPCSTR);
	...
	void WINAPI Helper_StrRemoveW( LPWSTR, WCHAR);
	void WINAPI Helper_StrRemoveA( LPSTR, CHAR);
#ifdef __cplusplus
}
#endif
